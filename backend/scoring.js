// ShopCompare scoring module.
// Contains the shopper-facing Value Score and the dropshipping
// Opportunity Score. These are intentionally separate concern areas.
// The demo catalog lives in ./data/demo-products.js.

const { demoProducts } = require("./data/demo-products.js");
...
function normalize(p, catalog = demoProducts) {
  return {
    id: String(p.id),
    name: p.name,
    store: p.store,
